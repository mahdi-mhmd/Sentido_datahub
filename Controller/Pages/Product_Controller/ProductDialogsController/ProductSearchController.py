from View.Pages.Product_Page.Product_Dialogs.ProductSearchDialog import ProductSearchDialog
...
class ProductSearchController:
    ...
    def __init__(self,theme,model):
        ...
        self.model = model
        self.view = None
        self.headers = ["Type","Name","Color","Qty","Price","Comment"]
    ...
    def setup_view(self):
        ...
        self.view = ProductSearchDialog(self.is_dark, types,self.headers, None)
