...
from View.Pages.Product_Page.Product_Dialogs.ProductRemoveDialog import ProductRemoveDialog


class ProductRemoveController(QObject):
    refresh_requested = Signal()

    def __init__(self, theme,model):
        super(ProductRemoveController, self).__init__()
        self.message = None
        self.is_dark = theme
        self.model = model
        self.view = None
    ...
    def setup_view(self):
        ...
        self.view = ProductRemoveDialog(self.is_dark, types)
    ...
    def remove_requested(self):
        ...
        result,success = self.model.remove(product_type, product_name,product_color)
