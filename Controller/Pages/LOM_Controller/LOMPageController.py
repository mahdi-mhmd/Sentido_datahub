from View.Pages.LOM_Page.LOMPageView import LOMPageView
from Model.Pages.LOMPageModel import LOMPageModel

from Controller.Pages.LOM_Controller.LOMDialogsController.LOMSearchController import LOMSearchController
from Controller.Pages.LOM_Controller.LOMDialogsController.LOMInsertController import LOMInsertController
from Controller.Pages.LOM_Controller.LOMDialogsController.LOMRemoveController import LOMRemoveController
from Controller.Pages.LOM_Controller.LOMDialogsController.LOMEditController import LOMEditController

class LOMPageController:
    ...
    def setup_view(self):
        ...
        suggestions = self.model.add_suggestion()
        self.view = LOMPageView(self.is_dark,self.table_data,suggestions)
    ...
    def adv_search_requested(self):
        self.adv_search_dialog = LOMSearchController(self.is_dark,self.model)
        self.adv_search_dialog.view.show()

    def insert_requested(self):
        self.insert_dialog = LOMInsertController(self.is_dark,self.model)
        self.insert_dialog.view.show()
        self.insert_dialog.refresh_requested.connect(self.refresh)

    def remove_requested(self):
        self.remove_dialog = LOMRemoveController(self.is_dark,self.model)
