from View.Pages.Mech_Page.MechPageView import MechPageView
from Model.Pages.MechPageModel import MechPageModel

from Controller.Pages.Mech_Controller.MechDialogsController.MechSearchController import MechSearchController
from Controller.Pages.Mech_Controller.MechDialogsController.MechInsertController import MechInsertController
from Controller.Pages.Mech_Controller.MechDialogsController.MechRemoveController import MechRemoveController
from Controller.Pages.Mech_Controller.MechDialogsController.MechEditController import MechEditController


class MechPageController:
    def __init__(self,theme):
        self.is_dark = theme
        self.view = None
        self.model = MechPageModel()
    ...
    def setup_view(self):
        ...
        self.view = MechPageView(self.is_dark,self.table_data,suggestions)
    ...
    def adv_search_requested(self):
        self.adv_search_dialog = MechSearchController(self.is_dark,self.model)
        self.adv_search_dialog.view.show()

    def insert_requested(self):
        self.insert_dialog = MechInsertController(self.is_dark,self.model)
        self.insert_dialog.view.show()
        self.insert_dialog.refresh_requested.connect(self.refresh)

    def remove_requested(self):
        self.remove_dialog = MechRemoveController(self.is_dark,self.model)
