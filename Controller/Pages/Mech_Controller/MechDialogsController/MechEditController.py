...
from View.Pages.Mech_Page.Mech_Dialogs.MechEditDialog import MechEditDialog
from View.MainElements.MessageDialog import MessageDialog

class MechEditController(QObject):
    refresh_requested = Signal()

    def __init__(self,theme,row,model):
        super(MechEditController,self).__init__()
        self.message = None
        self.is_dark = theme
    ...
    def setup_view(self):
        ...
        self.view = MechEditDialog(self.is_dark,types,self.current_row)
    ...
    def edit(self):
        new_data = [self.none_if_empty(self.view.mech_type.currentText()),
                    self.none_if_empty(self.view.mech_name.currentText()),
                    self.none_if_empty(self.view.mech_color.currentText()),
                    self.none_if_empty(self.view.mech_qty.value()),
                    self.none_if_empty(self.view.mech_comment.text())]
