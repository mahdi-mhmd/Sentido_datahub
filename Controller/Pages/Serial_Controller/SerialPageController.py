from View.Pages.Serial_Page.SerialPageView import SerialPageView
from Model.Pages.SerialPageModel import SerialPageModel

from Controller.Pages.Serial_Controller.SerialDialogsController.SerialSearchController import SerialSearchController
from Controller.Pages.Serial_Controller.SerialDialogsController.SerialInsertController import SerialInsertController
from Controller.Pages.Serial_Controller.SerialDialogsController.SerialRemoveController import SerialRemoveController
from Controller.Pages.Serial_Controller.SerialDialogsController.SerialEditController import SerialEditController

class SerialPageController:
    def __init__(self,theme):
        self.is_dark = theme
        self.view = None
        self.model = SerialPageModel()
    ...
    def setup_view(self):
        ...
        suggestions = self.model.fetch_suggestions()
        self.view = SerialPageView(self.is_dark,self.table_data,suggestions)
    ...
    def adv_search_requested(self):
        self.adv_search_dialog = SerialSearchController(self.is_dark,self.model)
        self.adv_search_dialog.view.show()

    def insert_requested(self):
        self.insert_dialog = SerialInsertController(self.is_dark,self.model)
        self.insert_dialog.view.show()
        self.insert_dialog.refresh_requested.connect(self.refresh)

    def remove_requested(self):
        self.remove_dialog = SerialRemoveController(self.is_dark,self.model)
