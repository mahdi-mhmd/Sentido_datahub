...
class OrderDtlInsertDialog(QDialog):
    insert_requested = Signal()
    close_requested = Signal()
    type_changed = Signal(str)

    def __init__(self, theme, type_list):
        super(OrderDtlInsertDialog, self).__init__()
        self.is_dark = theme
        self.setWindowTitle("Insert (OrderDtl)")
    ...
    def setup_widgets(self, layout):
        ...
        self.p_count.setRange(1, 100000)
        v_layout = QVBoxLayout()
        v_layout.addWidget(QLabel("Count"))
        v_layout.addWidget(self.p_count)
        h_layout.addLayout(v_layout,1)
    ...
    def setup_style(self):
        ...
        self.p_count.setStyleSheet(base_spinbox_style+theme_spinbox_style)
