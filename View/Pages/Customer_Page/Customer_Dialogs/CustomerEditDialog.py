...
class CustomerEditDialog(QDialog):
    ...
    def __init__(self, theme, name_list, current_data):
        ...
        self.customer_comment = QLineEdit(self)
    ...
    def setup_widgets(self, layout):
        ...
        for combobox, text,data, num in [(self.customer_name,"Name",self.current_data[0],1),(self.customer_tel,"Tel",self.current_data[1],1),
                                        (self.customer_city, "City",self.current_data[2],1),(self.customer_address,"Address",self.current_data[3],None)]:
        ...
        self.customer_comment.setFont(font)
        self.customer_comment.setText(self.current_data[4])
        v_layout = QVBoxLayout()
        v_layout.addWidget(QLabel("Comment"))
        v_layout.addWidget(self.customer_comment)
    ...
    def setup_style(self):
        ...
        self.customer_comment.setStyleSheet(base_lineedit_style + theme_lineedit_style)
